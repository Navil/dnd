...
CREATE OR REPLACE FUNCTION "public"."find_groups"("lat" double precision, "long" double precision, "remote" boolean) RETURNS TABLE("id" bigint, "created_at" timestamp with time zone, "is_remote" boolean, "description" "text", "owner_id" "uuid", "title" "text", "language" character varying, "dist_meters" double precision, "num_members" bigint, "num_dms" bigint)
...
ALTER FUNCTION "public"."find_groups"("lat" double precision, "long" double precision, "remote" boolean) OWNER TO "postgres";

CREATE OR REPLACE FUNCTION "public"."has_user_group_request"("group_id" bigint) RETURNS boolean
...
select exists(
  select 1
  from chats chat
  where chat.user_id = auth.uid() and chat.group_id = group_id)
$$;

ALTER FUNCTION "public"."has_user_group_request"("group_id" bigint) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."is_user_member_of_group"("group_id" bigint) RETURNS boolean
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
select exists(
  select 1
  from members member
  where member.user_id = auth.uid() and member.group_id = group_id)
$$;

ALTER FUNCTION "public"."is_user_member_of_group"("group_id" bigint) OWNER TO "postgres";
...
CREATE POLICY "Enable read access for all members" ON "public"."members" FOR SELECT TO "authenticated" USING ("public"."is_user_member_of_group"("group_id"));
...
GRANT ALL ON FUNCTION "public"."find_groups"("lat" double precision, "long" double precision, "remote" boolean) TO "anon";
GRANT ALL ON FUNCTION "public"."find_groups"("lat" double precision, "long" double precision, "remote" boolean) TO "authenticated";
GRANT ALL ON FUNCTION "public"."find_groups"("lat" double precision, "long" double precision, "remote" boolean) TO "service_role";

GRANT ALL ON FUNCTION "public"."has_user_group_request"("group_id" bigint) TO "anon";
GRANT ALL ON FUNCTION "public"."has_user_group_request"("group_id" bigint) TO "authenticated";
GRANT ALL ON FUNCTION "public"."has_user_group_request"("group_id" bigint) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."is_user_member_of_group"("group_id" bigint) TO "anon";
GRANT ALL ON FUNCTION "public"."is_user_member_of_group"("group_id" bigint) TO "authenticated";
GRANT ALL ON FUNCTION "public"."is_user_member_of_group"("group_id" bigint) TO "service_role";
